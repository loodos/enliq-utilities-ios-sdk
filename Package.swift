...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EIQJailbreakDetector",
            url: "https://github.com/loodos/enliq-utilities-ios-sdk/releases/download/0.0.4/eiqjailbreakdetector.xcframework.zip",
        ...
        .binaryTarget(
            name: "EIQOfflineControl",
            url: "https://github.com/loodos/enliq-utilities-ios-sdk/releases/download/0.0.4/eiqofflinecontrol.xcframework.zip",
        ...
        .binaryTarget(
            name: "EIQCommonUtils",
            url: "https://github.com/loodos/enliq-utilities-ios-sdk/releases/download/0.0.4/eiqcommonutils.xcframework.zip",
