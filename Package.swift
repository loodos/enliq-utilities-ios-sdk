...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "EIQJailbreakDetector",
            url: "https://github.com/loodos/enliq-utilities-ios-sdk/releases/download/0.0.3/eiqjailbreakdetector.xcframework.zip",
        ...
        .binaryTarget(
            name: "EIQOfflineControl",
            url: "https://github.com/loodos/enliq-utilities-ios-sdk/releases/download/0.0.3/eiqofflinecontrol.xcframework.zip",
        ...
        .binaryTarget(
            name: "EIQCommonUtils",
            url: "https://github.com/loodos/enliq-utilities-ios-sdk/releases/download/0.0.3/eiqcommonutils.xcframework.zip",
